...
class RepHAR(nn.Module):
    def __init__(self, nc_input, n_classes):
        ...
        self.stage1 = RepConvBlock(nc_input, n_fs, 3)
        self.stage2 = RepConvBlock(n_fs, n_fs*2, 3)

        # self.stage21 = RepConvBlock(128, 128, 3)
        # self.stage22 = RepConvBlock(128, 128, 3)
        # self.stage23 = RepConvBlock(128, 128, 3)
        # self.stage24 = RepConvBlock(128, 128, 3)
        # self.stage25 = RepConvBlock(128, 128, 3)

        self.stage3 = RepConvBlock(n_fs*2, n_fs*4, 3)
        
        self.fc = nn.Linear(n_fs*4, n_classes)
