...
model.load_state_dict(torch.load('MALANet_break/save/backup/'+dataset+ memo +'.pt'))
model.eval()
...
plt.savefig('MALANet_break/confMatrix/cm_'+dataset.lower()+memo+'.png', bbox_inches='tight')
plt.savefig('MALANet_break/confMatrix/cm_'+dataset.lower()+memo+'.eps', bbox_inches='tight')
