...
import json
# from bunch import Bunch  # Commented out - not compatible with Python 3.13
import os
import numpy as np
...
def get_config_from_json(json_file):
    ...
    # config = Bunch(config_dict)  # Using SimpleNamespace instead
...
def fft_find_each_amplitude(data, target_period):
    ...
    for i in range(batch_size):
        ...
        amplitudes[i] = float(closest_amplitude)
