...
train_X, train_Y = load_from_arff_file(os.path.join(DATA_PATH, "Heartbeat_TRAIN.arff"))
_, train_Y = np.unique(train_Y, return_inverse=True)

test_X, test_Y = load_from_arff_file(os.path.join(DATA_PATH, "Heartbeat_TEST.arff"))
