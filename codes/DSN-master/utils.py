...
def Read_Data(dataset, input_nc):
    ...
    return To_DataSet(train_X, train_Y), To_DataSet(test_X, test_Y), test_Y, train_Y
...
def input_pipeline(dataset, input_nc, bs):
    train_data, eval_data, y_test_unary, train_Y  = Read_Data(dataset, input_nc)
    ...
    eval_queue = DataLoader(
        ...
        pin_memory=True, num_workers=0)
    return train_queue, eval_queue, y_test_unary, train_Y
