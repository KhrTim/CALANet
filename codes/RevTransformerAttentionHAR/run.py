...
from models import RevTransformerAttentionHAR
...
model = RevTransformerAttentionHAR(input_nc, class_num, segment_size).cuda()
...
metrics_collector = MetricsCollector(
    model_name='RevTransformerAttentionHAR',
    dataset=dataset,
    task_type='HAR',
    save_dir='results'
)
